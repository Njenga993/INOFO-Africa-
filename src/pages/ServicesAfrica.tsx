    ...
    >
      ...
      >
        <motion.div className="text-content">
          <h2>Our Offerings</h2>
          <p>
            We provide comprehensive support to organic farmers across Africa
            through these key services, designed to build capacity, create
            market opportunities, and advocate for favorable policies.
          </p>
        </motion.div>
      ...
      >
        ...
        <div className="text-content">
          ...
          <p>
            Join us as an implementing partner, donor, or farmer
            representative. Help us scale organic agriculture for food
            security, climate adaptation, and youth empowerment across Africa.
          </p>
          <Link
            to="/contact"
            className="btn-primary"
