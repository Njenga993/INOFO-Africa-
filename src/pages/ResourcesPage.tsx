...
const ResourcesPage = () => {
    ...
    () => [
      {
        ...
        description:
          "Hands-on training session with local farmers learning sustainable practices",
        category: "Training",
      ...
      },
      {
        ...
        description:
          "Successful harvest season showcasing the results of organic farming methods",
        category: "Harvest",
      ...
      },
      {
        ...
        description:
          "Distribution of quality seeds to farming communities across the region",
        category: "Seeds",
      ...
      },
      {
        ...
        description:
          "Farmers showcasing their organic produce at local markets",
        category: "Market",
      ...
      },
      {
        ...
        description:
          "Installing new irrigation systems to conserve water resources",
      ...
      },
      {
        ...
        description:
          "Teaching children about agriculture through school gardens",
        category: "Education",
      ...
      },
      {
        ...
        description:
          "Natural pest control methods to protect crops without chemicals",
        category: "Training",
      ...
      },
      {
        ...
        description:
          "Introducing mobile apps for weather forecasting and market prices",
        category: "Technology",
      ...
      },
      {
        ...
        description:
          "Solar panels to power irrigation systems and storage facilities",
      ...
      },
      {
        ...
        description:
          "Establishing a cooperative for better market access and bargaining power",
        category: "Community",
  ...
  const navigateImage = (direction: "prev" | "next") => {
    if (direction === "prev") {
      ...
      setCurrentImageIndex(
        currentImageIndex === progressImages.length - 1
          ? 0
          : currentImageIndex + 1,
      );
    }
  ...
  const resourcesPageFaqs = [
    {
      question:
        "What kind of resources does INOFO Africa offer to organic farmers?",
      answer:
        "INOFO Africa provides comprehensive resources including educational publications on agroecology, practical guides for organic certification, case studies on sustainable farming practices, market access tools, weather forecasting apps, and our visual progress gallery showcasing successful farmer-led initiatives across Africa.",
    },
    {
      question:
        "How often are new farming resources added to INOFO Africa's database?",
      answer:
        "We continuously develop and update resources quarterly. New materials are announced through our newsletter subscription, social media channels, and directly on this Resources page. Seasonal guides are updated before each planting season to ensure relevance.",
    },
    {
      question:
        "Can local farming cooperatives contribute their success stories to INOFO Africa's resources?",
      answer:
        "Yes! INOFO Africa actively encourages member organizations and farming cooperatives to submit their success stories, case studies, and traditional knowledge. All contributions are reviewed by our technical committee and can be featured in our publications, gallery, or as downloadable resources for the wider farming community.",
    },
    {
      question:
        "Are INOFO Africa's resources available in multiple African languages?",
      answer:
        "We prioritize accessibility by offering key resources in English, French, Portuguese, Swahili, and major regional languages. Our goal is to make organic farming knowledge accessible to all African farmers regardless of language barriers.",
    },
    {
      question:
        "How can farmers access INOFO Africa's training materials if they have limited internet connectivity?",
      answer:
        "We provide offline solutions including printed manuals, USB drives with downloadable content for community centers, and mobile-friendly PDFs that can be shared via Bluetooth. Contact your regional INOFO Africa coordinator for physical resource distribution options.",
    },
  ];
  ...
  const resourcesPageCustomSchema = {
    ...
    description:
      "Explore INOFO Africa's comprehensive farming resources and visual progress gallery. Access educational materials, organic farming guides, market tools, and see impactful images from our work promoting agroecology across Africa.",
    ...
    publisher: {
      ...
      description:
        "The Indigenous Organic Farmers Federation of Africa — farmer-led, agroecological, and rooted in local knowledge.",
    },
    mainEntityOfPage: {
      "@type": "WebPage",
    ...
    hasPart: {
      ...
      description:
        "A visual journey showcasing INOFO Africa's impact across Africa through training workshops, community harvests, infrastructure projects, and farmer empowerment initiatives.",
    ...
    about: {
      ...
      description:
        "Educational materials and tools for sustainable agriculture in Africa",
    },
    audience: {
      "@type": "Audience",
      audienceType: [
  ...
  const howToUseResourcesSchema = {
    ...
    description:
      "Step-by-step guide to accessing and utilizing INOFO Africa's comprehensive farming resources",
    image: {
      "@type": "ImageObject",
      url: heroImg,
    },
    ...
    <>
      ...
      >
        ...
        >
          ...
          <meta
            itemProp="caption"
            content="INOFO Africa Resources - Supporting Organic Farmers Across Africa"
          />
        </motion.header>
        ...
        >
          <div className="coming-soon-container">
            <motion.div className="coming-soon-content" variants={itemVariants}>
            ...
            <motion.div className="coming-soon-image" variants={itemVariants}>
              <img
                src={comingSoonImg}
          ...
          <div className="gallery-header">
            <motion.div variants={itemVariants}>
              ...
              <p className="gallery-subtitle" itemProp="description">
                Enjoy the pictures below as we finalize the resources. These
                images showcase our ongoing work and the impact we're making
                together.
              </p>
            </motion.div>
          </div>
          ...
          >
            <div className="main-image-container">
              ...
              <div className="image-info">
                <h3 itemProp="name">
                  {progressImages[currentImageIndex].title}
                </h3>
                <p itemProp="description">
                  {progressImages[currentImageIndex].description}
                </p>
                <span className="category-tag" itemProp="keywords">
